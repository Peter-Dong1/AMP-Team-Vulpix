    ...
    while True:
        ...
        if message["type"] == "close":
            ...
            if vale_min_sell_order != -1 and valbz_max_buy_order != -1 and len(vale_sell_orders) > 0 and len(valbz_buy_orders) > 0:
                ...
                if vale_min_sell_order[0] * order_amount + 10 < valbz_max_buy_order[0] * order_amount: # check if we make profit
                ...
                if valbz_min_sell_order[0] * order_amount + 10 < vale_max_buy_order[0] * order_amount:
